...
from apps.profile_.views import ProfileListView, ProfileDetailView, ProfileCreateView, ProfileUpdateView, ProfileDeleteView

urlpatterns = [
    path('profile_/', ProfileListView.as_view(), name='profile_list'),
